// ref(a): https://web.physics.utah.edu/~detar/phys6720/handouts/lapack.html
// ref(b): https://web.physics.utah.edu/~detar/phys6720/handouts/fortran_binding.html (C++/Fortran Bindings)
// ref(compile call): g++ -O myprog.cc -o myprog -llapack -lblas -lgfortran -lm
